/**
 * Critical Icons - Inline SVGs for icons needed in the critical rendering path
 * 
 * These are hand-crafted inline SVGs to avoid loading the entire lucide-react
 * vendor chunk during initial page load. This reduces the critical path latency
 * by ~180ms (5.96 KiB saved from initial load).
 * 
 * Only icons used in:
 * - Navigation bar (ThemeToggle, SoundToggle)
 * - Onboarding modal
 * - Scroll-to-top button
 * 
 * All other icons should use lucide-react (loaded after initial render).
 */
